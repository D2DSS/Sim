...
%This class sets up variables for parameters of simulation of games
    ...
    M.MaxBallVelocity= max(1,floor((-1+sqrt(1+Nx*8*1/3))/2)); % a velocidade decai em 1 a cada iteracao
    M.KickRange = ((M.MaxBallVelocity*(M.MaxBallVelocity+1))/2); %aqui � calculado quanto que o chute vai percorrer
